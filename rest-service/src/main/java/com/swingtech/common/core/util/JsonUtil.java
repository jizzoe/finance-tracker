...
public class JsonUtil {
	...
	public static <T> T unmarshalJsonToObject(InputStream jsonInputStream, Class<T> valueType) {
		try {
			return MAPPER.readValue(jsonInputStream, valueType);
		} catch (Exception e) {
	...
	public static String prettyPrintJson(InputStream jsonString) {
		try {
			Object json = MAPPER.readValue(jsonString, Object.class);
			return MAPPER.writerWithDefaultPrettyPrinter().writeValueAsString(json);
		} catch (Exception e) {
